...
?>
	   ...
	   <h2 align="center"><blink>compose the email here</blink></h2>
			...
			<tr>
				<td>To:</td>
				<td><input type="text" value="<?=@$_SESSION['error']['email'];?>" name="email" id="email" class="adroid"/></td>
			</tr>
			<tr>
				<td>Subject:</td>
				...
				<td>Attachment:</td>
				<td><input type="file" name="datafile" id="datafile" style="width:60%" class="adroid"/></td>
			</tr>
			<tr>
